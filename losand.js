(() => {
    ...
    this.constructor === Object && _(_.prototype).define({
        on: {
            configurable: true,
            value (d, ...a) {
                a !== undefined ? a.forEach(v => this.v.on.call(this.v, v, d)) : _(d).give(this.v.on.bind(this.v));
                return this;
            }
        },
        off: {
            configurable: true,
            value (d, ...a) {
                a !== undefined ? a.forEach(v => this.v.off.call(this.v, v, d)) : _(d).give(this.v.off.bind(this.v));
                return this;
            }
        }
    });
